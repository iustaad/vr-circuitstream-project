...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=SHADGUM-RANGE&box=48.614769,25.445724,48.435702,25.284028
...
-----------
  ...
  * SHADGUM-RANGE Height Map (ASTER 30m).png
  ...
  * SHADGUM-RANGE Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * SHADGUM-RANGE Height Map (SRTM3 v4.1).png
  ...
  * SHADGUM-RANGE Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 336m (actual) is equal to 40m in
