...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=test-8km&box=23.327808,61.596762,23.176727,61.524897
...
-----------
  ...
  * test-8km Height Map (ASTER 30m).png
  ...
  * test-8km Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * test-8km Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 21m (actual) is equal to 40m in
